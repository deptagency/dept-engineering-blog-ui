...
export const processEnv: ProcessEnvProps = {
  ...
  platform,
  gaMeasurementId:
    process.env.JAMIFY_GA_MEASUREMENT_ID || appConfig.gaMeasurementId,
  nextImages: {
    feature: resolveBool(
  ...
  enableCareersPage: resolveBool(
    process.env.JAMIFY_ENABLE_CAREERS_PAGE,
  ...
  isr: {
    ...
    revalidate: resolveNumber(
      process.env.JAMIFY_NEXT_ISR_REVALIDATE,
